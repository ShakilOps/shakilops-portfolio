          ...
          <div className="top-section">
            <div className="left">
              <p className="about__subheading">
                Hi, I am <span>Shakil Ops</span>
              </p>
              <h2 className="about__heading">A MERN developer</h2>
              <div className="about__info">
                <PText>
                  I am from Dhaka, Bangladesh. A place of beauty and Digital.
                  ...
                  <br />
                  <br />
                  Interested in Web, Desktop and Mobile Developments.
                </PText>
              </div>
